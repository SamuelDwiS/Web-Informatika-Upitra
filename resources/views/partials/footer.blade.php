    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-5 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2 d-flex align-items-start">
                        ...
                        <span>Jl.Duwet No.1 Karangasem Laweyan Surakarta 57145</span>
                    </li>
                    <li class="mb-2 d-flex align-items-start">
                        <i class="fas fa-phone me-3 mt-1"></i>
                        <span>0811-290-7500</span>
                    </li>
                    <li class="mb-2 d-flex align-items-start">
                        <i class="fas fa-envelope me-3 mt-1"></i>
                        <span>admission@upitra.ac.id</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 col-lg-4 mb-4 text-center text-md-start">
                <h5 class="text-uppercase mb-4 fw-bold">Media Sosial</h5>
        ...
        <div class="row align-items-center">
            <div class="col-md-12 text-center">
                <p class="copyright">
                    &copy; {{ date('Y') }} Program Studi Informatika. All Rights Reserved.
                </p>
            </div>
        </div>
    </div>
